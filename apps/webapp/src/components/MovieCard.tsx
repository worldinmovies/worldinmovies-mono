...
export const MovieCard = ({ movie }: MovieCardProps) => {
  ...
  return (
    <Link to={`/movie/${movie.id}`} className="group relative block">
      <Card className="group relative overflow-hidden bg-gradient-card border-border hover:border-primary/50 transition-all duration-500 hover:scale-105 hover:shadow-cinematic">
